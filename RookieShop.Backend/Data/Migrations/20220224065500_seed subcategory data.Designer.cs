...
namespace RookieShop.Backend.Data.Migrations
{
    ...
    [Migration("20220224065500_seed subcategory data")]
    partial class seedsubcategorydata
    {
            ...
            modelBuilder.Entity("RookieShop.Backend.Models.Banner", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            BannerId = 1,
                            DateUpload = new DateTime(2022, 2, 24, 13, 55, 0, 101, DateTimeKind.Local).AddTicks(7021),
                        ...
                        {
                            BannerId = 2,
                            DateUpload = new DateTime(2022, 2, 24, 13, 55, 0, 102, DateTimeKind.Local).AddTicks(2407),
